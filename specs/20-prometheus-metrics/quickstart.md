# Quickstart: Prometheus Metrics Endpoint Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Prometheus Metrics Endpoint`.
