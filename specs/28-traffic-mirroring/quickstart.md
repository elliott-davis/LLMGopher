# Quickstart: Traffic Mirroring / Shadow Mode Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Traffic Mirroring / Shadow Mode`.
