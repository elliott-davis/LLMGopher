# Quickstart: Budget Lifecycle (Alerts & Periodic Resets) Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Budget Lifecycle (Alerts & Periodic Resets)`.
