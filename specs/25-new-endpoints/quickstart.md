# Quickstart: Image Generation, Audio & Rerank Endpoints Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Image Generation, Audio & Rerank Endpoints`.
