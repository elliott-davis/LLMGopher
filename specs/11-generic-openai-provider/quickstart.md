# Quickstart: Generic OpenAI-Compatible Provider Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Generic OpenAI-Compatible Provider`.
