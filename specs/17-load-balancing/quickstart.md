# Quickstart: Load Balancing Across Provider Deployments Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Load Balancing Across Provider Deployments`.
