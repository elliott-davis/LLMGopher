# Quickstart: Provider Retry with Exponential Backoff Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Provider Retry with Exponential Backoff`.
