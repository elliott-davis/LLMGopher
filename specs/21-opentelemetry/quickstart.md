# Quickstart: OpenTelemetry Distributed Tracing Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `OpenTelemetry Distributed Tracing`.
