# Quickstart: Additional OpenAI-Compatible Providers Verification
...
2. Configure the minimum providers, models, policies, or admin state required by `Additional OpenAI-Compatible Providers`.
